			...
			<div className="flex flex-1 flex-col justify-center gap-5 px-7">
				<div className="flex flex-col gap-3">
					<h1 className="text-foreground text-3xl font-bold tracking-tight">
						Só no computador (por enquanto)
					</h1>
					<p className="text-muted-foreground text-sm leading-relaxed">
						O OpenCut ainda não é otimizado para celular ou iPad. Algumas coisas vão quebrar e o layout vai ficar bagunçado. Use um computador para a experiência completa.
					</p>
				</div>
				<div className="flex items-center gap-3">
					<Button onClick={handleContinue}>Ver mesmo assim</Button>
