	...
	return (
		<Sheet>
			...
			<SheetContent>
				<SheetHeader>
					<SheetTitle>
						{isSelectMode ? `Select scenes (${selectedScenes.size})` : "Cenas"}
					</SheetTitle>
					<SheetDescription>
						{isSelectMode
							? "Selecione as cenas para excluir"
							: "Alterne entre as cenas do projeto"}
					</SheetDescription>
				</SheetHeader>
...
function DeleteDialog({
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent>
				<DialogHeader>
					<DialogTitle>Excluir cenas</DialogTitle>
					<DialogDescription>
						Tem certeza que deseja excluir {count} scene
						{count === 1 ? "" : "s"}? Isso não pode ser desfeito.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
